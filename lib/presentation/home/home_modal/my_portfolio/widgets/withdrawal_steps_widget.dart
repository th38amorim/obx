...
class WithdrawalStepsWidget extends StatelessWidget {
  const WithdrawalStepsWidget({
        ...
        children: [
          Column(
            children: [
              ...
              Text('Selecionar', style: TextStyle(fontSize: 12, color: Colors.grey))
            ],
          ),                           
          Column(
            children: [
          ...
          Column(
            children: [
              ...
              const SizedBox(height: 10),
              Text('Revisar', style: TextStyle(fontSize: 12, color: Colors.grey))
            ],
          ),
          Column(
            children: [
