...
class CustomBirthplaceConfirmPage extends StatelessWidget {
  CustomBirthplaceConfirmPage(
      {Key? key,
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text('País de nascimento: ' + context.read<SignUpFormCubit>().getFieldValue('birthCountry'), style: TextStyles.textConfirmPage),
                                    const SizedBox(height: 10),
                                    Text('Estado de origem: ' + context.read<SignUpFormCubit>().getFieldValue('birthState'), style: TextStyles.textConfirmPage),
                                    const SizedBox(height: 10),
                                    Text('Cidade de origem: ' + context.read<SignUpFormCubit>().getFieldValue('birthCity'), style: TextStyles.textConfirmPage),
                                    const SizedBox(height: 10),
                                    Text('Estado civil: ' + context.read<SignUpFormCubit>().getFieldValue('civilStatus'), style: TextStyles.textConfirmPage)
                                  ],
                                ),
                              ),
                            ),
