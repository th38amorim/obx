...
class PersonalDataSectionsStatus extends StatelessWidget {
  const PersonalDataSectionsStatus(
      {Key? key,
    })
      : super(key: key);
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Text('Endereço', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.black)),
                          Spacer(),
