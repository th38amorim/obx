...
class AccessDataSectionsStatus extends StatelessWidget {
  const AccessDataSectionsStatus(
      {Key? key,
    })
      : super(key: key);
      ...
      builder: (BuildContext context, SignUpFormState state) {
        return Column(
          children: [
            ...
            GestureDetector(
              onTap: () => pushAndReplaceToPage(context, SignUpScaffoldPage()),
              child: Container(
                  height: 55,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Text('Dados pessoais', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.black)),
                        Spacer(),
              ...
              Container(
                ...
                child: Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 20, right: 20),
                    child: Text('Endereço', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.white12)),
                  ),
                ),
              ),
              const SizedBox(height: 4),
              Container(
                ...
                child: Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: 20, right: 20),
                    child: Text('Financeiro e profissional', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.white12)),
                  ),
                ),
              ),
              const SizedBox(height: 4),
