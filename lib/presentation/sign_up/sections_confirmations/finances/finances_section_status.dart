...
class FinancesSectionsStatus extends StatelessWidget {
  const FinancesSectionsStatus(
      {Key? key,
    })
      : super(key: key);
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Text('Endereço', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.white60)),
                    Spacer(),
                    Icon(Icons.check, color: Colors.white54),
                  ],
                ),
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Text('Financeiro e profissional', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.white60)),
                    Spacer(),
                    Icon(Icons.check, color: Colors.white54),
                  ],
                ),
              ...
              child: Container(
                ...
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Text('Dados bancários', style: TextStyles.subtitles.copyWith(fontSize: 15, color:  Colors.black)),
                        Spacer(),
